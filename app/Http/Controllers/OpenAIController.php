...
class OpenAIController extends Controller
{
    ...
    public function send( Request $request ): Response
    {
        ...
        $response = $this->client->post( 'threads', new \stdClass() ); // We add stdClass here because we don't know why. Since the start, it was working fine but today it started to throw an error. 
