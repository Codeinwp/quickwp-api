...
class OpenAIController extends Controller
{
    ...
    public function send( Request $request ): Response
    {
        ...
        $params = [
            'assistant_id' => config('services.openai.assistant'),
        ];
        ...
        if ( ! empty( $message ) ) {
            ...
            if ( 'templates' === $step ) {
                $message .= ' | patterns-list.json file: ';
                $message .= json_encode( json_decode( file_get_contents( resource_path( 'prompts/placeholder.json' ) ) ), JSON_UNESCAPED_UNICODE|JSON_UNESCAPED_SLASHES );
            }

            if ( 'homepage' === $step ) {
                $template = $request->input( 'template' );
                $message .= ' | patterns-list.json file: ';
                $message .= json_encode( json_decode( file_get_contents( resource_path( 'prompts/homepage/' . $template . '.json' ) ) ), JSON_UNESCAPED_UNICODE|JSON_UNESCAPED_SLASHES );
            }
